<template>
    <nav>
        ...
        <div class="flex justify-between relative items-center p-4 md:p-5 lg:p-6 xl:p-8 2xl:p-10" v-show="!menuOpen">
            <NuxtLink to="/">
                <img src="/images/logos/logo.png" alt="The Rem-Tech Industries Logo" class="h-10 md:h-12 lg:h-14 xl:h-16 2xl:h-20 mr-4 w-auto">
            </NuxtLink>
        ...
        <div v-show="menuOpen" class="fixed top-0 w-full h-dvh z-10 flex flex-col items-center overflow-x-hidden overflow-y-auto" :class="props.menuclass" aria-modal="true" role="dialog">
            <div class="flex justify-between items-start w-full p-4 md:p-5 lg:p-6 xl:p-8 2xl:p-10">
                <div class="sm:flex">
                    <NuxtLink to="/">
                        <img src="/images/logos/logo.png" alt="The Rem-Tech Industries Logo" class="h-10 md:h-12 lg:h-14 xl:h-16 2xl:h-20 mb-2 sm:mb-0 sm:mr-2 md:mr-3 lg:mr-4 w-auto">
                    </NuxtLink>
                    <NuxtLink to="/alloys">
                        <img src="/images/logos/alloys-logo.png" alt="The Rem-Tech Alloys Logo" class="h-10 md:h-12 lg:h-14 xl:h-16 2xl:h-20 w-auto">
                    </NuxtLink>
                </div>
        ...
        <div ref="menuend" tabindex="-1"></div>
    </nav>
</template>
