    ...
    <div :class="{ 'max-h-0': menuIsOpen, 'overflow-hidden': menuIsOpen }">
        ...
        <div class="flex justify-center" v-show="!menuIsOpen">
            <div class="max-w-screen-2xl px-4 md:px-8 lg:px-12 xl:px-16 py-16 md:py-24 lg:py-32 xl:py-36 2xl:py-48">
                ...
                <p class="mb-8 lg:mb-12 xl:mb-16">At Rem-Tech Industries, we use cookies and similar tracking technologies to enhance your experience on our website, improve performance, and analyze how you interact with our site. This Cookie Policy explains what cookies are, how we use them, and your choices regarding their use. This policy is designed to comply with Canadian privacy laws, including the Personal Information Protection and Electronic Documents Act (PIPEDA), and outlines our commitment to protecting your privacy while using these technologies.</p>
                <h2 class="text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl mb-4 lg:mb-6 xl:mb-8">1. What Are Cookies?</h2>
                <p class="mb-8 lg:mb-12 xl:mb-16">Cookies are small text files that are placed on your device (computer, smartphone, or tablet) when you visit a website. They allow the website to recognize your device, store preferences, and provide insights into user behavior. Cookies can be "session cookies" (which are deleted when you close your browser) or "persistent cookies" (which remain on your device for a specified period or until manually deleted).</p>
...
useSeoMeta({
    ...
    description: 'At Rem-Tech Industries, we use cookies and similar tracking technologies to enhance your experience on our website, improve performance, and analyze how you interact with our site. This Cookie Policy explains what cookies are, how we use them, and your choices regarding their use. This policy is designed to comply with Canadian privacy laws, including the Personal Information Protection and Electronic Documents Act (PIPEDA), and outlines our commitment to protecting your privacy while using these technologies.',
    ogDescription: 'At Rem-Tech Industries, we use cookies and similar tracking technologies to enhance your experience on our website, improve performance, and analyze how you interact with our site. This Cookie Policy explains what cookies are, how we use them, and your choices regarding their use. This policy is designed to comply with Canadian privacy laws, including the Personal Information Protection and Electronic Documents Act (PIPEDA), and outlines our commitment to protecting your privacy while using these technologies.',
